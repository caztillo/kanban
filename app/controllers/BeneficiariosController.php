...
class BeneficiariosController extends \BaseController {
	...
	{
		return View::make('beneficiarios.create');
	}
	...
	public function show($id)
	{
		...
		return View::make('beneficiarios.show', compact('beneficiario'));
	}
